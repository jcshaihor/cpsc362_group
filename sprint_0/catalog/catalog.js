...
cpscBtn.addEventListener("click", () => {
    ...
    const list = `
        <h2>Computer Science List of CLasses</h2>
        <br>
        <p>
            List...
        </p>    
...
cpseBtn.addEventListener("click", () => {
    ...
    rightDiv.appendChild(input);
    const list = `
        <h2>Computer Engineering List of CLasses</h2>
        <br>
        <p>
            List...
        </p>    
...
poliBtn.addEventListener("click", () => {
    ...
    rightDiv.appendChild(input);
    const list = `
        <h2>Political Science List of CLasses</h2>
        <br>
        <p>
            List...
        </p>    
...
socBtn.addEventListener("click", () => {
    ...
    rightDiv.appendChild(input);
    const list = `
        <h2>Sociology List of CLasses</h2>
        <br>
        <p>
            List...
        </p>    
