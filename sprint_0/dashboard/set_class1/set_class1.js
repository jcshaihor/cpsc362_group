...
function card() {
    ...
    cardHeader.innerHTML = `<div class="card-header">When is the final exam for section 15?</div>`;
    ...
    cards.appendChild(testBody);
    testBody.innerHTML = `<hr><div class="posted-answer">The final exam is on May 19, 4pm - 5:50pm</div><div class="posted-by">mnchow98</div>`;
